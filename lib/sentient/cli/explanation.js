...
var Explanation = function () {
  ...
  self.print = function () {
    ...
    console.log("  --source");
    console.log();
    console.log("  The 'source' option changes the output to be the original");
    console.log("  source code that produced the pre-compiled program. This");
    console.log("  is useful if you want to update an existing program and");
    console.log("  re-compile it. This option takes precedence over 'run'.");
    console.log();
    console.log("  Examples:");
    console.log();
    console.log("    $ sentient --source");
    console.log();
    console.log("  --exposed");
    console.log();
    console.log("  The 'exposed' option changes the output to be a JSON");
    console.log("  structure that contains information about the exposed");
    console.log("  variables in a pre-compiled program. This is useful for");
    console.log("  determining which variables can be set in a program. This");
    console.log("  option takes precedence over 'run' and 'source'.");
    console.log();
    console.log();
    console.log("  Examples:");
    console.log();
    console.log("    $ sentient --exposed");
    console.log();
    console.log("  --assign");
    console.log();
