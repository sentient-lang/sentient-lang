...
var Explanation = function () {
  ...
  self.print = function () {
    ...
    console.log();
    console.log("  Programs will be bound to 'window.Sentient.programs' if");
    console.log("  global 'window' object is available and 'module.exports'");
    console.log("  the 'module' object is available. It is possible to store");
    console.log("  many programs in a single file by concatenating them");
