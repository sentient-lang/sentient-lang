...
var InstructionSet = function (params) {
  ...
  self.call = function (instruction) {
    switch (instruction.type) {
      ...
      case "get":
        ...
        break;
      case "fetch":
        self.fetch(instruction.defaultValue);
        break;
      case "width":
        self.width();
        break;
  ...
  self.fetch = function (defaultValue) {
    self.get(true);
    self.swap();
    ...
    if (typeof defaultValue === "undefined") {
      ...
      if (typeName(defaultValue) !== valueType) {
        message = "Unable to set a default value of '" + defaultValue + "'";
      ...
      codeWriter.instruction({ type: "constant", value: defaultValue });
