...
var InstructionSet = function (params) {
  ...
  self.call = function (instruction) {
    ...
    switch (instruction.type) {
      ...
      case "invariant":
        ...
        break;
      case "define":
        self.define(instruction.name, instruction.args);
        break;
      case "return":
  ...
  self.define = function (name, args) {
    ...
    recording = { name: name, args: args, body: [], depth: 1 };
  };
  ...
  var copySymbol = function (symbol, newSymbol, from, to) {
    ...
    to.symbolTable.set(newSymbol, type, symbols);
