  ...
  var parseFunctionCall = function (expression) {
    ...
    switch (functionName) {
      ...
      case "eachCombination":
        macros.eachCombination(argExpressions, instructions);
      break;
      case "eachCons":
        macros.eachCons(argExpressions, instructions);
      break;
      case "eachSlice":
        macros.eachSlice(argExpressions, instructions);
      break;
      case "reduce":
        macros.reduce(argExpressions, instructions);
      break;
      case "push":
        macros.push(argExpressions, instructions);
      break;
      default:
        parseArgs();
